        ...
        <div className='hero'>
            <div className="heroSection left">
                ...
                <motion.h1
                    ...
                    Hey There! <br /> <span>I'm Akash</span>
                </motion.h1>
                ...
                <motion.div variants={awardVariants} initial="initial" animate="animate" className="awards">
                    ...
                    <motion.p variants={awardVariants}>Hello, I'm a MERN stack Developer</motion.p>
            ...
            <div className="heroSection right">
                ...
                {/* CONTACT BUTTON */}
                <motion.a href="/#contact" animate={{ x: [200, 0], opacity: [0, 1] }} transition={{ duration: 2 }} className='contactLink'>
